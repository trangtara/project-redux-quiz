...
const SummaryText = () => {
  ...
  const goodScoreUrl = 'https://media.giphy.com/media/lKaehH06fXsGIrB6Qo/giphy.gif';
  return (
    <>
      ...
      {correctAnswers.length < 3 ? <SummaryGif gif={badScoreUrl} /> : <SummaryGif gif={goodScoreUrl}/>}
